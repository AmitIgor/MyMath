...
public class test {
	...
	public static void main(String[] args) {
		...
		System.out.println("Check #0.a: Errors: \n");
		Polynom_able polyERROR = new Polynom("2x^0 + 3x^-4 + 5x^2 - x");
//		System.out.println("Check #8.b: Root of the polynom p1 in range [-4,-1] ");
		Polynom pERRORroot = new Polynom ("1x^5 - 5x^4 + 2x^3 + 14x^2 - 3x^1 - 9x^0");			
		System.out.println(pERRORroot.root(-2, 0, Double.MIN_VALUE)+"\n");
		
		//יצירת סטרינג
		System.out.println("Check #1.a: Creating a polynom from a string: \n");
		String strCheck = "2.0x^0 - 1.0x^1 + 5.0x^2 + 3.0x^4";
		Polynom_able poly1 = new Polynom("2.0x^0 - 1.0x^1 + 5.0x^2 + 3.0x^4");
